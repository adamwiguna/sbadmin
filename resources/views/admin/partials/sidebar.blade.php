<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon bg-white p-1 rounded-circle " >
            <img src="/Lambang_Kabupaten_Tabanan.png" alt="" width="30" height="30">
        </div>
        <div class="sidebar-brand-text text-lg-center mx-3">NOTULEN</div>
    </a>
